...
namespace NCrawler.HtmlProcessor
{
	...
	/// </summary>
	public abstract class CrawlerRules
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CrawlerRules"/> class. 
		/// </summary>
		protected CrawlerRules()
		{
		}
		...
		/// </param>
		protected CrawlerRules(Dictionary<string, string> filterTextRules, Dictionary<string, string> filterLinksRules)
		{
